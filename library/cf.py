...
# 계좌 번호 쉽게 알아보는법: 콘솔창에 보면 제일 위쪽에 로그로 get_login_info!!! 아래 계좌 번호가 출력이 된다.
imi1_accout="8166753011"
...
# TR_REQ_TIME_INTERVAL_LONG=30

# openapi 1회 조회 시 대기 시간
TR_REQ_TIME_INTERVAL=0.2

# 1초당 5회 조회를 1번 발생시킨 경우 대기 시간
...
# dart api key
dart_api_key = 'cd04e0cdde3e21fa6953c37a6dab4dc9b5e11824'